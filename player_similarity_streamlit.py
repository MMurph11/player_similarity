...
def getData():
    similarity_df = pd.read_csv('https://github.com/MMurph11/player_similarity/blob/main/similarity_df.csv')
    metrics_df = pd.read_csv('https://github.com/MMurph11/player_similarity/blob/main/metrics_df.csv')
