...
def getData():
    similarity_df = pd.read_csv('https://github.com/MMurph11/player_similarity/blob/7e1a9b7407f36ff9cbaea9568529740de3cf2d6d/similarity_df.csv')
    metrics_df = pd.read_csv('https://github.com/MMurph11/player_similarity/blob/7e1a9b7407f36ff9cbaea9568529740de3cf2d6d/metrics_df.csv')
